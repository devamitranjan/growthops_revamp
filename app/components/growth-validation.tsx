  ...
  return (
    <section className="reveal mt-[80px] >md:mt-[100px]">
      <div className="generic-container">
        ...
        <div className="relative flex md:flex-col h-[415px] w-full bg-gradient-to-b >md:bg-gradient-to-r from-primary-blue-extradark via-primary-blue-dark to-primary-cyan-base rounded-[40px] overflow-hidden">
          <div className=">md:w-2/5 md:h-1/2 flex flex-col justify-center >md:pl-16 md:px-6 md:pt-8">
          ...
          <div className="relative >md:w-3/5 md:h-1/2">
            <img
              src="/placeholder.svg"
