  ...
  return (
    <header>
      <div className="generic-container w-full absolute top-0 left-0 _header_4b1x2_1">
        ...
        <button className="fixed right-0 mr-6 >md:mr-20 bg-neutral-white-base/20 flex flex-col gap-1.5 h-14 w-14 scale-100 md:scale-75 rounded-full justify-center items-center group transition ease-out duration-300 hover:bg-neutral-white-base/40">
