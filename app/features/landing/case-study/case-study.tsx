          ...
          <div className="swiper-wrapper generic-container absolute w-full left-0 bottom-0 z-10">
            <div className="flex gap-[18px] md:gap-8 overflow-x-auto">
              ...
              <button
                ...
                className="group relative aspect-video w-72 shrink-0 flex flex-col justify-end rounded-xl overflow-hidden p-4 shadow-lg cursor-pointer bg-cover bg-center bg-[url('/placeholder.svg')] text-left"
              >
              ...
              {caseStudySlides.map((slide) => (
                <CaseStudySlide key={slide.label} slide={slide} />
              ))}
            </div>
          </div>
        </div>
