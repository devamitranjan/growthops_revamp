/** Content shapes for the home page composition.
 *
 *  These describe what the CMS is expected to hand back. Once Sanity TypeGen
 *  runs, the generated result types should be narrowed to these (or replace
 *  them outright) — nothing else in the app defines content shapes. */
...
/** Everything `getHomePage()` resolves — one document's worth of content. */
export interface HomePageData {
  hero: IHeroBannerData;
  services: ServiceItem[];
  growthSpurts: GrowthCardData[];
  unrivaledGrowth: IUnrivaledGrowthData;
  caseStudies: CaseStudySlideData[];
  articles: ArticleData[];
  team: ITeamSectionData;
}
