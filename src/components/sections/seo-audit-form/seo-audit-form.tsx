...
const darkInputClasses =
  "w-full rounded-md bg-[#010101] px-5 py-3 body1-regular text-neutral-white-base placeholder-neutral-grey-base outline-none transition duration-300 focus:ring-2 focus:ring-primary-pink-base";
...
const radioClasses = "h-4 w-4 shrink-0 accent-primary-pink-base cursor-pointer";
...
export function SeoAuditFormView({
  ...
  return (
    <section className={className}>
      <div className="generic-container flex flex-col gap-8 md:gap-12">
        <h1 className="heading-h1-extrabold text-neutral-white-base">
        ...
        >
          ...
          <Form.Field name="agencyType" className="flex flex-col gap-3">
            ...
            <div className="flex gap-6">
              <div className="flex items-center gap-2">
                <Form.Control
                  ...
                  required
                />
                <label className={`${labelClasses} cursor-pointer`}>Yes</label>
              </div>
              <div className="flex items-center gap-2">
                <Form.Control
                  type="radio"
                  ...
                  required
                />
                <label className={`${labelClasses} cursor-pointer`}>No</label>
              </div>
            </div>
          </Form.Field>

          {/* Company Website */}
          <Form.Field name="companyWebsite" className="flex flex-col gap-2">
            <Form.Label className={labelClasses}>
          ...
          {/* Advertising Budget */}
          <Form.Field name="adBudget" className="flex flex-col gap-2">
            <Form.Label className={labelClasses}>
            ...
            <Form.Control
              type="text"
              placeholder={placeholders.adBudget || "Enter your monthly budget"}
              required
              className={darkInputClasses}
            />
            <Form.Message match="valueMissing" className={messageClasses}>
          ...
          {/* Email Consent */}
          <Form.Field name="emailConsent" className="flex gap-3">
          ...
          {/* Terms Consent */}
          <Form.Field name="termsConsent" className="flex gap-3">
            <Form.Control
              type="checkbox"
          ...
          <div className="pt-4">
            <Form.Submit asChild>
              ...
              >
                {isSubmitted
                  ? "Submitted!"
                  : settings.seoAuditFormSubmitLabel || "Get Free SEO Audit"}
              </button>
            </Form.Submit>
          </div>
